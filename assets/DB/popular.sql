INSERT INTO `roles`(`rol`) VALUES('admin'),('alumno'),('cliente');

INSERT INTO`lineas` ( `Nombre`, `Color`,`Descripcion`) VALUES 
( 'Revitalizante', 'FFC0CB',
...
INSERT INTO `productos` (`Precio`, `Stock`, `Descripcion`, `ID_Linea`, `Nombre`) VALUES 
('20', '10', 'demo', '1', 'Aceite'),
...
VALUES 
('admin@gmail.com', 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', 1),
...
INSERT INTO `carrito` (`IDUsuario`,`IDProducto`,`Cantidad`) VALUES (2,2,2),
(2,4,1),
(2,5,3),
(2,6,1);
